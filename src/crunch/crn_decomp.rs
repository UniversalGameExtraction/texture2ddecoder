...
pub fn crnd_get_crn_format_bits_per_texel(fmt: &mut crn_format) -> u32{
    return match fmt {
        crn_format::cCRNFmtDXT1 |
        crn_format::cCRNFmtDXT5A |
        crn_format::cCRNFmtETC1 => 4,
        ...
        crn_format::cCRNFmtDXT5_AGBR => 8,

        _ => {assert!(false); return 0;}
    };
}

pub fn crnd_get_bytes_per_dxt_block(fmt: &mut crn_format) -> u32{
